...
dataSpanReturn = quoteClass.get_dataMultiDates(secIDs=stockPools[dates_test [0]], dates=dates_test , fields=['Open','Close'], showProcess=True)
...
for date in dates_test:
    ...
    for order in range(0,orders):
        ...
        SpanReturns = dataSpanReturn['SpanReturn'][(dataSpanReturn['dates'] == date) & (dataSpanReturn['order'] == order)]
